...
\date[8/11/2019]{PPPL Graduate Summer School, 2019}
...
\begin{frame}{Single particle motion in an electromagnetic field}
  ...
  \begin{itemize}
    ...
    \item These characteristics satisfy the ODE of particles moving
      ...
      \end{align*}
    \item In PIC one uses a large number of macro-particles to follow
      a bunch of characteristics in phase-space. These macro-particles
      move given the electromagnetic field. As the particles move they
      ``deposit'' charges and currents on a grid, which are in turn
      used to update the electromagnetic field.
